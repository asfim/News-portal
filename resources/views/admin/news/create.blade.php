...
<div class="container-fluid px-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold text-dark mb-1">Create Article</h2>
            <p class="text-secondary mb-0">Compose and publish a new news post to the portal.</p>
        </div>
    ...
    <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-4">
                    ...
                    <div class="tab-pane fade show active" id="contentSec" role="tabpanel" aria-labelledby="content-tab">
                        <div class="card border-0 shadow-sm rounded-3 p-4 mb-4">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control py-3" id="title" name="title" value="{{ old('title') }}" placeholder="Compose a catchy title..." required autofocus>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="short_description" name="short_description" rows="3" placeholder="Write a short summary that appears in lists..." required>{{ old('short_description') }}</textarea>
                            </div>
                        ...
                        <div class="card border-0 shadow-sm rounded-3 p-4 mb-4">
                            <div class="row g-4 mb-4">
                                <div class="col-md-6">
                                    ...
                                    <div class="bg-light p-3 rounded-3 text-center border">
                                        <input type="hidden" name="featured_image" id="featured_image_id" value="{{ old('featured_image') }}">
                                        <img id="featured_image_preview" src="" class="img-fluid rounded mb-3 d-none" style="max-height: 150px; object-fit: contain;">
                                        <div id="featured_image_placeholder" class="text-secondary py-4 small">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="bg-light p-3 rounded-3 text-center border">
                                        <input type="hidden" name="thumbnail" id="thumbnail_id" value="{{ old('thumbnail') }}">
                                        <img id="thumbnail_preview" src="" class="img-fluid rounded mb-3 d-none" style="max-height: 150px; object-fit: contain;">
                                        <div id="thumbnail_placeholder" class="text-secondary py-4 small">
                                            <i class="fa-regular fa-image display-6 mb-2 opacity-50"></i>
                                            <p class="mb-0">No image selected</p>
                                        </div>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control py-3" id="source_name" name="source_name" value="{{ old('source_name') }}" placeholder="e.g. Reuters, AFP">
                                </div>
                                <div class="col-md-6">
                                    <label for="source_url" class="form-label fw-semibold text-secondary">Source Article URL</label>
                                    <input type="url" class="form-control py-3" id="source_url" name="source_url" value="{{ old('source_url') }}" placeholder="https://source-agency.com/article">
                                </div>
                            </div>
                                ...
                                <div class="d-flex flex-wrap gap-2 p-3 bg-light rounded-3 border">
                                    @foreach($tags as $tag)
                                        <div class="form-check form-check-inline border bg-white px-3 py-1.5 rounded-pill mb-0 d-flex align-items-center">
                                            <input class="form-check-input mt-0 me-2" type="checkbox" name="tags[]" id="tag_{{ $tag->id }}" value="{{ $tag->id }}" {{ is_array(old('tags')) && in_array($tag->id, old('tags')) ? 'checked' : '' }}>
                    ...
                    <div class="tab-pane fade" id="seoSec" role="tabpanel" aria-labelledby="seo-tab">
                        <div class="card border-0 shadow-sm rounded-3 p-4 mb-4">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control py-3" id="meta_title" name="meta_title" value="{{ old('meta_title') }}" placeholder="Leave blank to use article title">
                            </div>

                            <div class="mb-4">
                                <label for="meta_description" class="form-label fw-semibold text-secondary">Meta Description</label>
                                <textarea class="form-control" id="meta_description" name="meta_description" rows="3" placeholder="Provide SEO description summary...">{{ old('meta_description') }}</textarea>
                            </div>

                            <div class="mb-4">
                                <label for="meta_keywords" class="form-label fw-semibold text-secondary">Meta Keywords</label>
                                <input type="text" class="form-control py-3" id="meta_keywords" name="meta_keywords" value="{{ old('meta_keywords') }}" placeholder="e.g. politics, news, breaking">
                            </div>

                            <div class="mb-3">
                                <label for="canonical_url" class="form-label fw-semibold text-secondary">Canonical URL</label>
                                <input type="url" class="form-control py-3" id="canonical_url" name="canonical_url" value="{{ old('canonical_url') }}" placeholder="https://canonical-url.com">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="card bg-light bg-opacity-25 border-0 p-4 rounded-3 mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select py-3" id="author_id" name="author_id" required>
                            ...
                            @foreach($authors as $auth)
                                <option value="{{ $auth->id }}" {{ old('author_id') == $auth->id ? 'selected' : '' }}>{{ $auth->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select py-3" id="status" name="status" required>
                            ...
                            <option value="pending" {{ old('status') == 'pending' ? 'selected' : '' }}>Pending Moderation</option>
                            <option value="published" {{ old('status') == 'published' ? 'selected' : '' }}>Publish Immediately</option>
                            <option value="scheduled" {{ old('status') == 'scheduled' ? 'selected' : '' }}>Schedule Publication</option>
                        </select>
                    </div>

                    <div class="mb-4 d-none" id="scheduleTimeSec">
                        <label for="publish_at" class="form-label fw-semibold text-secondary">Publication Date & Time</label>
                        <input type="datetime-local" class="form-control py-3" id="publish_at" name="publish_at" value="{{ old('publish_at') }}">
                    </div>
                    ...
                    <div class="border-top pt-4">
                        ...
                        <div class="form-check form-switch ps-0 mb-3">
                            ...
                            <input class="form-check-input ms-0 border-secondary-subtle float-end" style="width: 2.2em; height: 1.1em;" type="checkbox" id="breaking_news" name="breaking_news" value="1" {{ old('breaking_news') ? 'checked' : '' }}>
                        </div>

                        <div class="form-check form-switch ps-0 mb-3">
                            <label class="form-check-label fw-semibold text-dark small" for="featured_news">Homepage Featured Block</label>
                            <input class="form-check-input ms-0 border-secondary-subtle float-end" style="width: 2.2em; height: 1.1em;" type="checkbox" id="featured_news" name="featured_news" value="1" {{ old('featured_news') ? 'checked' : '' }}>
                        </div>

                        <div class="form-check form-switch ps-0 mb-3">
                            <label class="form-check-label fw-semibold text-dark small" for="trending_news">Trending Article</label>
                            <input class="form-check-input ms-0 border-secondary-subtle float-end" style="width: 2.2em; height: 1.1em;" type="checkbox" id="trending_news" name="trending_news" value="1" {{ old('trending_news') ? 'checked' : '' }}>
                        </div>
                ...
                <div class="text-end">
                    <button type="submit" class="btn btn-primary w-100 py-3 rounded-pill fw-semibold shadow-sm"><i class="fa-solid fa-circle-check me-2"></i> Save Article</button>
                </div>
            </div>
        </div>
    </form>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let mediaTarget = ''; // featured_image or thumbnail
        ...
        function loadModalMedia() {
            ...
            .then(res => res.json())
            .then(data => {
                // Parse returned grid HTML and append custom click listeners
