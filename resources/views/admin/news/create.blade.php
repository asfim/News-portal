                    ...
                    <div class="tab-content" id="articleTabsContent">
                            ...
                            <div class="card border-0 shadow-sm rounded-3 p-4 mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control py-3" id="slug" name="slug"
                                        value="{{ old('slug') }}" placeholder="auto-generated-slug" required>
                                </div>
                        ...
                        <div class="tab-pane fade" id="mediaSec" role="tabpanel" aria-labelledby="media-tab">
                            <div class="card border-0 shadow-sm rounded-3 p-4 mb-4">
                                ...
                                <div class="mb-4">
                                    <label for="video_url" class="form-label fw-semibold text-secondary">YouTube / Video
                                        URL</label>
                                ...
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="url" class="form-control py-3" id="source_url"
                                            name="source_url" value="{{ old('source_url') }}"
                            ...
                            <div class="card border-0 shadow-sm rounded-3 p-4 mb-4">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control py-3" id="meta_title" name="meta_title"
                                        value="{{ old('meta_title') }}" placeholder="Leave blank to use article title">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" id="meta_description" name="meta_description" rows="3"
                                        placeholder="Provide SEO description summary...">{{ old('meta_description') }}</textarea>
                                </div>
                ...
                <div class="col-lg-4">
                            ...
                            <select class="form-select py-3" id="author_id" name="author_id" required>
                                ...
                                @foreach ($authors as $auth)
                                    <option value="{{ $auth->id }}"
                                        {{ old('author_id') == $auth->id ? 'selected' : '' }}>{{ $auth->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select py-3" id="status" name="status" required>
                                ...
                                <option value="published" {{ old('status') == 'published' ? 'selected' : '' }}>Publish
                                    Immediately</option>
                                <option value="scheduled" {{ old('status') == 'scheduled' ? 'selected' : '' }}>Schedule
                                    Publication</option>
                            </select>
                        </div>
                        ...
                        <div class="border-top pt-4">
                            ...
                            <div class="form-check form-switch ps-0 mb-3">
                                ...
                                <input class="form-check-input ms-0 border-secondary-subtle float-end"
                                    ...
                                    name="featured_news" value="1" {{ old('featured_news') ? 'checked' : '' }}>
                            </div>
                    ...
                    <div class="text-end">
                        <button type="submit" class="btn btn-primary w-100 py-3 rounded-pill fw-semibold shadow-sm"><i
                                class="fa-solid fa-circle-check me-2"></i> Save Article</button>
                    </div>
                </div>
            </div>
        </form>
